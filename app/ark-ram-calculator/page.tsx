...
const MAPS = {
  "the-island":     { label: "The Island",     vanilla: 13, light: 15, heavy: 17 },
  "the-center":     { label: "The Center",     vanilla: 13, light: 15, heavy: 17 },
  "scorched-earth": { label: "Scorched Earth", vanilla: 13, light: 15, heavy: 17 },
  aberration:       { label: "Aberration",     vanilla: 13, light: 15, heavy: 17 },
  extinction:       { label: "Extinction",     vanilla: 13, light: 15, heavy: 17 },
  ragnarok:         { label: "Ragnarok",       vanilla: 15, light: 17, heavy: 19 },
  valguero:         { label: "Valguero",       vanilla: 15, light: 17, heavy: 19 },
  "lost-colony":    { label: "Lost Colony",    vanilla: 19, light: 22, heavy: 24 },
  astraeos:         { label: "Astraeos",       vanilla: 19, light: 20, heavy: 24 },
} as const;
...
export default function ArkRamCalculator() {
      ...
      <Card className="bg-[#0E1222] rounded-2xl sm:rounded-3xl bg-radial-[at_30%_75%] from-[#10294E] to-[#0E1222] calculator-card">
        <CardContent className="py-4 px-4 sm:px-6 md:px-12">
          <div className="grid gap-6 md:gap-12 md:grid-cols-2">
            {/* Left: title + price + recommended RAM */}
